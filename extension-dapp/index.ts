...
const win = typeof window !== typeof undefined?window as Window & InjectedWindow:{} as Window & InjectedWindow;
...
export function web3Enable (originName: string, compatInits: (() => Promise<boolean>)[] = []): Promise<InjectedExtension[]> {
  ...
  return web3EnablePromise as Promise<InjectedExtension[]> }
